  ...
  return (
    <div className='w-full h-screen flex items-start flex-col md:flex-row'>
      ...
      <div className='relative w-full md:w-1/2 h-full flex flex-col'>
        <img src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExbGtpeHRwdXdvOTRqaWJtb3dzZnB4eWZ4YTRvbTVtcTg3eHZoMmo3MSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/tAnvFB51UTTBoJMbZj/giphy.webp" 
            alt="Game Background" className='object-cover w-full h-full' />
        <div className='absolute text-white top-[20%] left-[10%] md:top-[20%] md:left-[15%] flex flex-col'>
          <h1 className='text-4xl md:text-5xl font-bold my-4 font-pixelify'>Turn Your Ideas Into Reality</h1>
          <p className='text-md md:text-lg font-normal'>Start for free and get attractive offers from the community</p>
        </div>
      </div>

      {/* Right Side: Form Section */}
      <div className='w-full md:w-1/2 h-full flex flex-col p-4 md:p-8 lg:p-10'>
        <h1 className='w-full text-lg md:text-xl font-semibold max-w-[500px] mx-auto mb-10'>Interactive Brand</h1>

        <div className='w-full max-w-[500px] mx-auto flex flex-col'>
          <div className='w-full flex flex-col mb-2'>
            <h3 className='text-2xl md:text-3xl font-semibold mb-2 font-pixelify '>Login</h3>
          ...
          <div className='w-full flex flex-col md:flex-row items-center justify-between mb-4'>
            ...
            <p className='text-sm underline cursor-pointer mt-2 md:mt-0'>Forgot Password?</p>
          </div>
          ...
          <div className='w-full flex items-center justify-center relative mb-2'>
            ...
            <p className='text-lg absolute bg-white px-2 text-black/70 left-1/2 transform -translate-x-1/2'>or</p>
          </div>
        ...
        <div className='w-full flex items-center justify-center mt-4 md:mt-16'>
          <p className='text-sm'>Don't have an account?  
            <span className='underline cursor-pointer ml-1 font-semibold'>Sign up for free</span>
          </p>
        </div>
      </div>
    </div>
